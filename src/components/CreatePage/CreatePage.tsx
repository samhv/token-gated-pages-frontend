...
export function CreatePage() {
    ...
    return (
        <div>
            ...
            <p className="mt-5 opacity-70">Collection address (Goerli only)</p>
            ...
            <p className="mt-5 opacity-70">Secret content</p>
            <p className="opacity-50">Only be visible for people that owns an item from the collection</p>
            <textarea onChange={(e) => setDescription(e.target.value)} value={description} className="mt-0.5 block border border-black h-28 px-5 py-3 rounded-md text-base w-full md:w-[460px]" placeholder="You can find the One Piece in..." />
